...
\begin{center}
\fbox{
\url{chisel.eecs.berkeley.edu/documentation/bootcamp-20130930.pdf}
}
\end{center}
...
class ByteSelectorTests(c: ByteSelector) 
  ...
  defTests {
    ...
    for (t <- 0 until 4) {
      ...
      val ref_out = UInt((test_in >> (t * 8)) & 0xFF)
...
\begin{frame}[fragile]{Chisel Standard Library}
\begin{itemize}
\item Bits Properities
\item Numeric Utilities
\item Stateful Functions
\item Priority Encoding FUnctions
\item Queues and Pipes
\item Arbiters
\end{itemize}
\end{frame}
