...
%, \verb+target+ is the type of memory used.
...
class CrossbarIo(n: Int) extends Bundle {
  ...
  val sel = UFix(width = log2up(n), dir = INPUT)
...
A user first defines the complete interface to a ROM and RAM as follows:
