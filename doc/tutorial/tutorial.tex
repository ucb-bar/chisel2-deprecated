...
class Fifo[T <: Data] (n: Int, type: T) 
  ...
  val enq_ptr      = Reg(reset = UInt(0, sizeof(n)))
  val deq_ptr      = Reg(reset = UInt(0, sizeof(n)))
  val is_full      = Reg(reset = Bool(false))
...
\begin{scala}
class DecoupledDemo 
  extends Decoupled()( new DataBundle )
\end{scala}
...
class Fifo[T <: Data] (n: Int)(data: => T) 
    extends Module {
  val io = new Bundle {
    val enq = new Decoupled( data ).flip()
