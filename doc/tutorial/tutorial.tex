...
Cascaded conditional updates are prioritized from bottom to top in
...
val regfile = Mem(64, io.data_in1);           // A memory with no ports, with data width derived from another signal.
