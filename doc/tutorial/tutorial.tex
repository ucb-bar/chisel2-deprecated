...
non-input nodes being interpreted as expected values.\footnote{Note that
only output nodes are accessible, not internal nodes of a component.}
\code{test} first sends inputs specified in vars, steps the DUT and then either
