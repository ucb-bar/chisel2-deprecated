...
\noindent
which binds a tester to a module, and where specify nodes to test,
...
\noindent
When \code{-{-}test} is given as an argument to \code{chiselMainTest}, 
...
only output nodes are accessible, not internal nodes of a module.}
