...
\begin{center}
\includegraphics[height=0.4\textheight]{programming-scala.pdf} \\
\includegraphics[height=0.4\textheight]{programming-in-scala.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{gcd.pdf} 
\end{center}
...
\verb+Map(ins, x => x * y)+ \\
\begin{center}
\includegraphics[height=0.6\textheight]{map.pdf} \\[2cm]
\end{center}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{chain.pdf} \\
\end{center}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{linecount.png}
\end{center}
...
\begin{center}
\includegraphics[height=0.8\textheight]{perf.pdf}
\end{center}
...
\includegraphics[height=0.7\textheight]{ibm45.png}
