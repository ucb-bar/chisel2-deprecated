...
In the test harness \verb+ByteSelectorTests+ we see that the test portion is written in Scala with some Chisel constructs inside a \verb+Testy+ class definition. The device under test is passed to us as a parameter \verb+c+. 
