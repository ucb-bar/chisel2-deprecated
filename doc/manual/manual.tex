...
object Reg {
  def apply[T <: Data]
    (type: T, updateVal: T = null, resetVal: T = null): T
}
 
object RegUpdate {
  def apply[T <: Data] (updateVal: T, resetVal: T = null): T
}
...
and allows users to write tests using the given debug protocol.  In particular, users use:
\begin{itemize}
